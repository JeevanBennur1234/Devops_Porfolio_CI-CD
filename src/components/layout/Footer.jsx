    ...
    <footer className="bg-slate-100 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-8 pt-8 border-t border-slate-200 dark:border-slate-800 text-center text-slate-500 dark:text-slate-400 text-sm">
          ...
          <p className="mt-1">Built with React, Vite, Tailwind CSS, and Framer Motion.</p>
          <p className="mt-1 text-xs text-slate-400 dark:text-slate-500">v2.1.0 &bull; CI/CD Enabled &bull; Deployed on AWS S3 + CloudFront</p>
        </div>
      </div>
    </footer>
  );
